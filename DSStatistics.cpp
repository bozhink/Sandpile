 ...
 * *****************************************************************************
 */
DSStatistics::DSStatistics(ADSModel*sds, char*fn_s, char*fn_t)
{
    sds->GetSize(&Lx, &Ly);
...
void DSStatistics::Simulate(ADSModel*sds)
{
    /* Generating data */
...
void DSStatistics::Simulate(ADSModel*sds, int skip)
{
    /* Generating data */
    for (int i=0; i<N_STATISTICS; i++)
    {
...
void DSStatistics::Simulate(ADSModel*sds, int skip, int termalizationTime)
{
