...
public class NESDSModel {
	 ...
	 */
	public NESDSModel(int lx, int ly) {
		Lx = lx;
		Ly = ly;
		...
		exportImage = false;
		current = 0;
		System.err.println("You must not use exporting methods using this constuctor");
	}
	 ...
	 */
	public NESDSModel(int lx, int ly, int width, int height, String name) {
		filename = name;
		Lx = lx;
		Ly = ly;
		w = width / Lx;
