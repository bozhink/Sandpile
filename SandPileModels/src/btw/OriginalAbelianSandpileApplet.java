...
/*
<applet code="OriginalAbelianSandpileApplet" width=600 height=600 />
*/

public class OriginalAbelianSandpileApplet extends Applet implements Runnable
{
	...
	private OriginalAbelianSandpile model = new OriginalAbelianSandpile(nx, ny);
